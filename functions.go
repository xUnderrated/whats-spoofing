...
func sendSpoofedTalkDemo(chatJID types.JID, spoofedJID types.JID, toGender string, language string, spoofedFile string) {
	...
	msgmap["en"]["generic"][0] = "feen..."
	msgmap["en"]["generic"][1] = "39lti 3la dakchi dyal 9bila hhhhhhhh"
	msgmap["en"]["generic"][2] = "anhwi mok wax zmlti wla malk"
	msgmap["en"]["generic"][3] = "banlya bdat katchdk zmla mnin bditi katgls hda zidan"
	msgmap["en"]["generic"][4] = "sir t9awd rah dakchi kaybda ghir bdhk"
	msgmap["en"]["generic"][5] = "My deliciousness..."
	msgmap["en"]["generic"][6] = "msali krk msift liya had lhotel f us..."
	msgmap["en"]["boy"] = make(map[int]string)
	msgmap["en"]["boy"][0] = "ahya brojola aji hwini skhnt 9bila f l9ism m3a zidan..."
